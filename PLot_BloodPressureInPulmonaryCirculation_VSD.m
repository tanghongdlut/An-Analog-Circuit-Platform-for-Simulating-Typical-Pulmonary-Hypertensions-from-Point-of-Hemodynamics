...
for num1=samNum+1:2*samNum
    Plpap(num1,:)=allP(300*samNum+num1,20);
    Plpad(num1,:)=allP(300*samNum+num1,21);
    Plpv(num1,:)=allP(300*samNum+num1,24);
    Prv(num1,:)=allP(300*samNum+num1,18);
    Pla(num1,:)=allP(300*samNum+num1,25);
    num1=num1+1;
end
